...
public class SimpleTable {
    ...
    public int[] align;
    public int qCol;
    public ArrayList<JFrame> listJF = new ArrayList();
    public String trgCol;
    public TableNzVer3 tableFrameModel = null;
    ...
    public SimpleTable(String table, String col, String val, String trgCol) {
        ...
        if (trgCol != null && listColumn.contains(trgCol)) {
            ...
            for (int i = 0; i < tSize; i++) {
                if (!trgCol.equals(listColumn.get(i))) {
                    cols[cnt++] = listColumn.get(i);
                }
            }
        } else {
            cols = listColumn.toArray(new String[tSize]);
        }
