...
public class SimpleFrame1 extends javax.swing.JFrame {

    SimpleTable tt;// = new SimpleTable(null, null, null, null);

    public SimpleFrame1(String selectT){//, ArrayList<String> colums) {
        tt = new SimpleTable(selectT, null, null);
...
//    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("удалить таблицу");
