...
/*@author Lev */
public class AddAbonent extends javax.swing.JFrame {
    
    JComboBox abComboBox;
    
    public AddAbonent() {
        initComponents();
    }
    public AddAbonent(JComboBox x) {
        initComponents();
        abComboBox = x;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Наименование абонента");
        ...
        jLabel3.setText("Алгоритмическое имя абонента");

        jLabel5.setText("Путь к файлу Excel с данными абонента");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 371, Short.MAX_VALUE))
                    ...
                    .addComponent(jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 371, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String[] colNames = {"Abonent","Наименование","Path_to_Excel", "Abonent_type"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAbonent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
